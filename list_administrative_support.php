        ...
        <div class="card-header">
            <div class="card-tools">
                <a class="btn btn-block btn-sm btn-default btn-flat border-primary"
                    href="./index.php?page=new_employee"><i class="fa fa-plus"></i> Add New Administrative Support</a>
            </div>
        </div>
        <div class="card-body">
            <table class="table table-hover table-bordered" id="list">
                ...
                <tbody>
                    <?php
					$i = 1;
					$qry = $conn->query("SELECT *, concat(Fname,' ',Minit, ' ', Lname) as name FROM Employee Join administrative_support on Employee.SSN = administrative_support.SSN order by Employee.SSN asc");
                    $i++;
