        ...
        <div class="card-body">
            <table class="table table-hover table-bordered" id="list">
                ...
                <tbody>
                    <?php
					$i = 1;
					$qry = $conn->query("SELECT Employee.SSN, concat(Employee.Fname,' ',Employee.Minit, ' ', Employee.Lname) as name, EType FROM Employee Join Engineer on Employee.SSN = Engineer.SSN");
                    $i++;
