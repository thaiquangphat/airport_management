...
class Action
{
    ...
    function save_airplane() {
        ...
        // Construct the SQL query
            ...
            $sql = "UPDATE Airplane (License_plate_num, AirlineID, OwnerID, ModelID, LeasedDate) VALUES ('$License_plate_num', '$AirlineID', '$OwnerID', '$ModelID', '$LeasedDate') WHERE AirplaneID = '$AirplaneID";
